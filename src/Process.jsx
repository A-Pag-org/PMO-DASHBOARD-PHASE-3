...
import { C, Bar, InfoButton, Dropdown, DateRange, DetailDrawer, PinIcon, GRID } from "./ui.jsx";
...
export default function Process({ initiative, region, onNavigate }) {
    ...
    <div style={{ minHeight: "100vh", background: C.paper, fontFamily: "'Source Sans 3', system-ui, sans-serif", color: C.body }}>
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 24px", background: "#fff",
        ...
        <div style={{
          ...
          <AirQualityPill onNavigate={onNavigate} currentRegion={region || "All-Delhi NCR"} />
        </div>
